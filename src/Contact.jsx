...
function Contact() {
  return (
    ...
    <div id='contact' className=' d-flex justify-content-center align-items-center' >
      ...
      <div className='w-100  px-lg-5 p-4 p-lg-0' data-aos="fade-up">
      ...
      <div className='d-flex flex-lg-row flex-md-row flex-column col-12 justify-content-start' data-aos="fade-up" >
      

      <div className='col-lg-7 col-md-6 col-12 row d-flex p-lg-5 p-md-4 p-sm-3 p-4 justify-content-start'>
            
        <div className='contact'>
        <img src="email.png" alt="" style={{objectFit: 'cover', width: '50px', height: 'auto'}}  />
        <p className='mt-1 p-0 m-0 description' style={{fontWeight: 'bold', fontSize: '16px', color: '#323131'}} > 
            Email
        </p>
        ...
        <div className=' contact'>
        <img src="instagram.png" alt="" style={{objectFit: 'cover', width: '50px', height: 'auto'}} />
        <p className='mt-1 p-0 m-0 description' style={{fontWeight: 'bold', fontSize: '16px', color: '#323131'}} > 
            Instagram
        </p>
        <p className='description' style={{fontWeight: 'normal', fontSize: '16px', color: '#323131'}} > 
        ...
        <div className=' contact'>
        <img src="linkedin.png" alt="" style={{objectFit: 'cover', width: '50px', height: 'auto'}} />
        <p className='mt-1 p-0 m-0 description' style={{fontWeight: 'bold', fontSize: '16px', color: '#323131'}} > 
            Linkedin
        </p>
        <p className=' description' style={{fontWeight: 'normal', fontSize: '16px', color: '#323131'}} > 
