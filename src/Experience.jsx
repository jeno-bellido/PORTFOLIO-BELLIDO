...
import snLogo from './sn-logo.svg'
    ...
    <div id='experience' className='d-flex justify-content-center align-items-center mb-5' >
        <div className=' d-flex justify-content-center align-items-center flex-column' style={{width: "100%"}}>
            ...
            <div className='d-flex col-12 row justify-content-start p-lg-4 p-4' >
                <div className='col-lg-4 col-md-6 col-sm-6 col-12 d-lg-flex d-flex pb-5 order-4'>
                    <div className=' rounded-5'>
                        <div className='project-bg'>
                            ...
                            <div>
                                ...
                                <p style={{ textAlign: 'justify', fontWeight: '300'}} > Spring Valley Tech Corp · Internship <br /> Negros Occidental, Western Visayas, Philippines · On-site </p>
                ...
                <div className=' rounded-5'>
                        <div className='project-bg'>
                            ...
                            <div>
                                ...
                                <p style={{ textAlign: 'justify' , fontWeight: '300'}}> Forever Passion Dream Inc. · Part-time <br /> New York, United States · Remote </p>
                ...
                <div className=' rounded-5'>
                        <div className='project-bg'>
                            ...
                            <div>
                                <h4 className='mb-1'> Software Engineer </h4> 
                                <p style={{ textAlign: 'justify', fontWeight: '300'}} > Mediaset · Full-time <br />  Oslo, Norway · Remote </p>
                                <p style={{ textAlign: 'justify', fontWeight: '300'}} > 
                ...
                <div className='col-lg-4 col-md-6 col-sm-6 col-12 d-lg-flex d-flex pb-5 order-1'>
                    <div className=' rounded-5'>
                        <div className='project-bg'>
                            <div className='mb-3'>
                                <img src={snLogo} style={{width: '50%'}} alt="" />
                            </div>
                            <div>
                                <h4 className='mb-1'> AI Software Engineer </h4> 
                                <p style={{ textAlign: 'justify', fontWeight: '300'}} > SharpNexus · Full-time <br /> Toronto, Canada · Remote </p>
                                <p style={{ textAlign: 'justify', fontWeight: '300'}} > 
                                • Responsible for full-stack development, including planning, designing, and implementing features across the entire software development lifecycle, along with integration of cloud solutions (AWS)
                                <br /> • Led the implementation of a Retrieval-Augmented Generation (RAG) system using OpenAI and open-source models, featuring real-time, voice-based interaction that allows users to talk naturally with the AI—creating a fluid, human-like experience for discussing database data. 
